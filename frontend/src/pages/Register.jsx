    ...
    <div className="auth-screen">
      ...
      <div className="auth-card" style={{ zIndex: 10 }}>
        <div className="auth-header">
          ...
          <p>Sign up to create, auto-save, and score your resumes for free.</p>
        </div>
        ...
        <form className="auth-form" onSubmit={handleSubmit} autoComplete="off">
          <div className="form-group">
            <label htmlFor="auth-fullname">Full Name <span className="required">*</span></label>
            <input
              type="text"
              id="auth-fullname"
              required
              placeholder="e.g. Kumkum Kushwaha"
              value={name}
        ...
        {isPlaceholder ? (
          <button className="btn btn-secondary btn-block" onClick={handleGoogleMockSignup} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px" }}>
        ...
        <p style={{ textAlign: "center", marginTop: "24px", color: "var(--text-muted)", fontSize: "14px" }}>
          Already have an account? <Link to="/login" style={{ color: "#6366f1", textDecoration: "none", fontWeight: "500" }}>Log In</Link>
        </p>
      </div>
    </div>
  );
